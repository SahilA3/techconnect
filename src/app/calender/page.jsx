...
const page = () => {
  return (
    <>
      <div className="flex items-center justify-center py-8 px-4 bg-gray">
        <div className="max-w-sm w-full shadow-lg ">
          <div className="md:p-8 p-5 dark:bg-purple-800 bg-white rounded-t bg-darkpurple text-snow">
          ...
          <div className="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-50 rounded-b bg-black text-snow">
            <div className="px-4">
