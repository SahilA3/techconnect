...
const Highlights = () => {
  return (
    <>
      <div className="w-auto bg-darkpurple text-black h-auto text-snow">
        <div className="container my-5 mx-auto md:px-6 pb-5">
          <section className="mb-32 text-center">
            <h2 className="mb-12 text-center text-3xl font-bold pt-10">HIGHLIGHTS</h2>
