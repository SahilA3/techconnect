...
const page = () => {
  return (
    <>
      <div className="w-[100vw] h-auto bg-gray py-10">
        <div className="container py-10 my-5 mx-auto md:px-6 text-snow bg-purple rounded-3xl">
          <section className="mb-32 text-center">
            <h2 className="mb-12 text-center text-3xl font-bold">NEWS</h2>
